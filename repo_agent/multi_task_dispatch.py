...
class Task:
    def __init__(self, task_id: int, dependencies: List[Task], extra_info: Any = None):
        ...
        self.status = 0  # Task status: 0=not started, 1=in progress, 2=completed, 3=error
...
class TaskManager:
    ...
    def mark_completed(self, task_id: int):
        ...
        with self.task_lock:
            ...
            self.task_dict.pop(task_id)  # Remove from task dictionary
...
if __name__ == "__main__":
    ...
    def some_function():  # Sleep for a random duration
